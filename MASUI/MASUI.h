...
//! Project version number for MASUI.
FOUNDATION_EXPORT double MASUIVersionNumber;

//! Project version string for MASUI.
FOUNDATION_EXPORT const unsigned char MASUIVersionString[];
